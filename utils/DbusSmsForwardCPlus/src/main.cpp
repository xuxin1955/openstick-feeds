...
#include "DirectAction/directaction.h"
...
int main(int argc, char* argv[])
{
    ...
    // --listsms / --sendsms= must be intercepted before onStartGuide, otherwise
    // the program blocks waiting on stdin when no mode argument was given.
    int directActionResult = tryDirectAction(argc, argv);
    if (directActionResult >= 0) {
